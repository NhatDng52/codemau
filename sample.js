...
import{StoreCarToFB,StoreRouteToFB,StoreDriverToFB , getAllDriver, getAllCar, getAllRoute} from './index.js';
...
export class Car{
    ...
    #status ;
     price ;
     driver; //set this #when done the update method and manger's view auth
